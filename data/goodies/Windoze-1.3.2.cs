"      NAME	Windoze 3D borders and title bar 1.3.2
       AUTHOR	ssadams@us.ibm.com (Sam Adams and Andreas Raab)
       URL	(none)
       FUNCTION	Adds partial Windoze look and feel to Squeak windows
       KEYWORDS	Squeak Windows Windoze
       ST-VERSIONS	Squeak
       PREREQUISITES	Squeak 1.3 or higher
...
This goodie enhances Andreas Raab's NiceSystemViewby adding 3D borders ala Windoze and by enhancingthe title bar for a close emulation.This version fixes a bug in the border graphics for collapsed windows

				Sam Adams and Andreas Raab
"!
'From Squeak 1.3 of Jan 16, 1998 on 6 February 1998 at 2:25:19 pm'!
...
!NiceSystemView methodsFor: 'label accessing' stamp: 'ssa 2/6/98 14:24'!
labelHeight
	^self isCollapsed
		ifFalse:[18 + 6]
...
!NiceSystemView methodsFor: 'bordering' stamp: 'ssa 2/6/98 14:22'!
displayBorder
...
!NiceSystemView methodsFor: 'bordering' stamp: 'ssa 2/6/98 14:21'!
...
!NiceSystemView methodsFor: 'bordering' stamp: 'ssa 2/6/98 14:17'!
displayLabelBorder
	"Display the receiver's label border."
...
23:36'!
new 	"This is a rather dirty hack -- but we don't have a window builder
yet. (ar 1/22/98 23:36)" 	^Preferences nicerSystemViews 		ifTrue:[NiceSystemView
basicNew initialize] 		ifFalse:[self basicNew initialize]! !


!NiceSystemView class methodsFor: 'class initialization' stamp: 'ar 1/22/98
23:13'!
initialize 	"NiceSystemView initialize"! !
