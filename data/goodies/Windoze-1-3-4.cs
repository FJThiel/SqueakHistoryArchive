"      NAME	Windoze-1-3-4.cs
       AUTHOR	ssadams@us.ibm.com (Sam S. Adams, Andreas Raab, Stephen Pope)
       URL	(none)
       FUNCTION	Windoze look and feel for Squeak Smalltalk UI
       KEYWORDS	Windoze windows scrollbar
       ST-VERSIONS	Squeak
       PREREQUISITES	Squeak 1.3
       CONFLICTS	overrides standard flop-out scrollbars and hides subview resizing with a left-shift-hack
       DISTRIBUTION	world
       VERSION	1.3.4
       DATE	23-Mar-98
...
This change set includes both the new look and feel for windows as well as the previously seperate ScrollBar Junta code.

				Sam S. Adams, Andreas Raab, Stephen Pope
"!
'From Squeak 1.3 of Jan 16, 1998 on 20 March 1998 at 11:41:56 pm'!
...
!NotifyStringHolderController methodsFor: 'menu messages' stamp: 'ssa 3/22/98 23:54'!
proceed
	"Proceed execution of the suspended process."
	"Changed view superView to view topView - ssa 3/22/98 23:54"
